...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.dt_debut'
        db.add_column(u'events_events', 'dt_debut',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Events.dt_fin'
        db.add_column(u'events_events', 'dt_fin',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.dt_debut'
        db.delete_column(u'events_events', 'dt_debut')

        # Deleting field 'Events.dt_fin'
        db.delete_column(u'events_events', 'dt_fin')
