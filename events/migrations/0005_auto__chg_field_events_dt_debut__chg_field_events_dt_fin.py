...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Events.dt_debut'
        db.alter_column(u'events_events', 'dt_debut', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Events.dt_fin'
        db.alter_column(u'events_events', 'dt_fin', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Events.dt_debut'
        db.alter_column(u'events_events', 'dt_debut', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Events.dt_fin'
        db.alter_column(u'events_events', 'dt_fin', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        u'events.events': {
            ...
            'dt_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'dt_fin': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
