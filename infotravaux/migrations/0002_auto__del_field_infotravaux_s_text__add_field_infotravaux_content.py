...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InfoTravaux.s_text'
        db.delete_column(u'infotravaux_infotravaux', 's_text')

        # Adding field 'InfoTravaux.content'
        db.add_column(u'infotravaux_infotravaux', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InfoTravaux.s_text'
        db.add_column(u'infotravaux_infotravaux', 's_text',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)

        # Deleting field 'InfoTravaux.content'
        db.delete_column(u'infotravaux_infotravaux', 'content')
    ...
    models = {
        ...
        u'infotravaux.infotravaux': {
            'Meta': {'object_name': 'InfoTravaux'},
