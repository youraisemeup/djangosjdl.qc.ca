...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InfoTravaux'
        db.create_table(u'infotravaux_infotravaux', (
        ...
        db.send_create_signal(u'infotravaux', ['InfoTravaux'])


    def backwards(self, orm):
        # Deleting model 'InfoTravaux'
        db.delete_table(u'infotravaux_infotravaux')
