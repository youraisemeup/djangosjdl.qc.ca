...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommuniquesPresse'
        db.create_table(u'documentation_communiquespresse', (
        ...
        db.send_create_signal(u'documentation', ['CommuniquesPresse'])


    def backwards(self, orm):
        # Deleting model 'CommuniquesPresse'
        db.delete_table(u'documentation_communiquespresse')
