...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.sub_category'
        db.add_column(u'documentation_document', 'sub_category',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.sub_category'
        db.delete_column(u'documentation_document', 'sub_category')
    ...
    models = {
        u'documentation.category': {
            ...
            'order': ('django.db.models.fields.CharField', [], {'default': "u'date'", 'max_length': '200'}),
        ...
        u'documentation.document': {
            ...
            'sub_category': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200'})
        },
        u'documentation.subcategory': {
            'Meta': {'object_name': 'SubCategory'},
            'fk_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['documentation.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200'})
        },
        u'sites.site': {
