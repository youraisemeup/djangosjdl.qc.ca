...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcesVerbauxRegieTraitement.category'
        db.add_column(u'documentation_procesverbauxregietraitement', 'category',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ProcesVerbauxRegieAssainissement.category'
        db.add_column(u'documentation_procesverbauxregieassainissement', 'category',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcesVerbauxRegieTraitement.category'
        db.delete_column(u'documentation_procesverbauxregietraitement', 'category')

        # Deleting field 'ProcesVerbauxRegieAssainissement.category'
        db.delete_column(u'documentation_procesverbauxregieassainissement', 'category')
