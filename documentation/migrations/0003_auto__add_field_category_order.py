...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'documentation_category', 'order',
                      self.gf('django.db.models.fields.CharField')(default=u'date', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.order'
        db.delete_column(u'documentation_category', 'order')
