...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentReglementsMunicipaux.doctitle'
        db.add_column(u'documentation_documentreglementsmunicipaux', 'doctitle',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentReglementsMunicipaux.doctitle'
        db.delete_column(u'documentation_documentreglementsmunicipaux', 'doctitle')
