...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'News.s_text'
        db.delete_column(u'news_news', 's_text')

        # Adding field 'News.content'
        db.add_column(u'news_news', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'News.s_text'
        db.add_column(u'news_news', 's_text',
                      self.gf('mezzanine.core.fields.RichTextField')(default=''),
                      keep_default=False)

        # Deleting field 'News.content'
        db.delete_column(u'news_news', 'content')
