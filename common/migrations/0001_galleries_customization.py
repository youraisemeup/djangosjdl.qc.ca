...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryImage.credits'
        db.add_column(u'galleries_galleryimage', u'credits',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryImage.credits'
        db.delete_column(u'galleries_galleryimage', u'credits')
