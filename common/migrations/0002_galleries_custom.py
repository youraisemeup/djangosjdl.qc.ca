...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GalleryImage.title'
        db.add_column(u'galleries_galleryimage', u'title',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GalleryImage.title'
        db.delete_column(u'galleries_galleryimage', u'title')
    ...
    models = {
        ...
        u'galleries.galleryimage': {
            ...
            u'credits': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            u'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'pages.page': {
