...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coordonnees.contact_name'
        db.alter_column(u'coordonnees_coordonnees', 'contact_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Coordonnees.contact_name'
        db.alter_column(u'coordonnees_coordonnees', 'contact_name', self.gf('django.db.models.fields.CharField')(max_length=255))
