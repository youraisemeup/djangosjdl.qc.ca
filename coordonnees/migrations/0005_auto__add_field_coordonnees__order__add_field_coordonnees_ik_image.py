...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coordonnees.ik_image'
        db.add_column(u'coordonnees_coordonnees', 'ik_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coordonnees._order'
        db.delete_column(u'coordonnees_coordonnees', '_order')

        # Deleting field 'Coordonnees.ik_image'
        db.delete_column(u'coordonnees_coordonnees', 'ik_image')


    models = {
        u'coordonnees.coordonnees': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Coordonnees'},
            ...
            'pages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pages.Page']", 'symmetrical': 'False'}),
