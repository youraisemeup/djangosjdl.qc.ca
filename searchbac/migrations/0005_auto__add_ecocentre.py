...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ecocentre'
        db.create_table(u'searchbac_ecocentre', (
        ...
        db.send_create_signal(u'searchbac', ['Ecocentre'])


    def backwards(self, orm):
        # Deleting model 'Ecocentre'
        db.delete_table(u'searchbac_ecocentre')
