...
jQuery(function($) {
    ...
    if (typeof tinyMCE != 'undefined') {
        ...
        tinyMCE.init({
            ...
            theme_advanced_buttons1: "bold,italic,underline,|,sub,sup,|,link,unlink,|,image,|,media,charmap,|,bullist,numlist,blockquote,|,formatselect,|,search,replace,|,fullscreen,",
            theme_advanced_buttons2: ",table,tablecontrols,row_props,cell_props,delete_col,delete_row,col_after,col_before,row_after,row_before,split_cells,merge_cells,",
            theme_advanced_buttons3: "undo,redo,|,cut,copy,paste,|,hr,|,code,removeformat,",
