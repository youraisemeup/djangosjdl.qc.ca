...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Careers'
        db.create_table(u'careers_careers', (
        ...
        db.send_create_signal(u'careers', ['Careers'])


    def backwards(self, orm):
        # Deleting model 'Careers'
        db.delete_table(u'careers_careers')


    models = {
        u'careers.careers': {
            'Meta': {'object_name': 'Careers'},
