...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RepertoryLinks.excerpt'
        db.alter_column(u'usefullinks_repertorylinks', 'excerpt', self.gf('mezzanine.core.fields.RichTextField')(null=True))

    def backwards(self, orm):

        # Changing field 'RepertoryLinks.excerpt'
        db.alter_column(u'usefullinks_repertorylinks', 'excerpt', self.gf('mezzanine.core.fields.RichTextField')())
    ...
    models = {
        ...
        u'usefullinks.repertorylinks': {
            ...
            'excerpt': ('mezzanine.core.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
